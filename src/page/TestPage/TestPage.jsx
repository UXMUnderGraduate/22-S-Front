          ...
          <Box>
            ...
            <Button
              onClick={async () => {
                ...
                .then((res) => {
                ipfsCid = res.data.data.cid;
                })
                .catch((err) => {
                  console.log(err);
                });
                console.log(data.settlementAddr);
                const deployedNftContract = await deployContract.nft(ipfsCid, data.settlementAddr);
                ...
                .post(`http://${process.env.REACT_APP_BACKEND_URL}/api/v1/nft/create`,
                {
                  ...
                  "txId": deployedNftContract.options.address
                },
                {
                  headers: {
                      'Content-Type': 'application/json',
